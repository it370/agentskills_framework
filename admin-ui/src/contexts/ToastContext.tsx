...
function ToastNotification({ message, type, onClose }: ToastNotificationProps) {
  ...
  return (
    <div className="animate-slide-in-right">
      <div className={`${style.bg} rounded-lg shadow-lg border ${style.border} p-4 flex items-start gap-3 min-w-[320px] max-w-md`}>
        <div className="flex-shrink-0">
          <svg className={`w-5 h-5 ${style.icon}`} fill="currentColor" viewBox="0 0 20 20">
            {style.iconPath}
          </svg>
        </div>
